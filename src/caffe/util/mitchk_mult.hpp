#ifndef MITCHK_MULT_HPP_
#define MITCHK_MULT_HPP_
...
void mitchk_mult(Fixed<I,F> *op1, Fixed<I,F> *op2, unsigned int k, unsigned int total_bits)
{
    Fixed<128,0> N1;
    Fixed<128,0> N2;
    Fixed<128,0> K2;
