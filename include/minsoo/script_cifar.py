...
def file_gen():
    ...
    for i in range(2,17):
        ...
        f.write("make;\n")
        f.write("./examples/cifar10/test_full.sh 2> Bit_log/fracbit/fixed" + str(intbits) + "_" + str(fracbits) + ".log\n")
        
        intbits = i;
        fracbits = 64 - i;
        f.write("cp ./include/minsoo/intbit/fixed" + str(intbits) + "_" + str(fracbits) + ".hpp ./include/minsoo/fixed.hpp;\n")
        f.write("make;\n")
        f.write("./examples/cifar10/test_full.sh 2> Bit_log/intbit/fixed" + str(intbits) + "_" + str(fracbits) + ".log\n")
