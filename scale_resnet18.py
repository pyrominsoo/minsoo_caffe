...
net = caffe.Net('models/resnet18_no_batnorm/train.prototxt', 'models/resnet18_no_batnorm/no_batnorm_iter_200000.caffemodel', caffe.TEST)
new_net = caffe.Net('models/resnet18_no_batnorm/train.prototxt', 'models/resnet18_no_batnorm/no_batnorm_iter_200000.caffemodel', caffe.TEST)
...
for idx in range(len(net.layers)):
  ...
  if (layer.type == 'Convolution'):
    ...
    try:
      ...
      print(idx)
      print(list(net.layers)[idx])
new_net.save('models/resnet_scale/resnet18_nobat_scale.caffemodel')
